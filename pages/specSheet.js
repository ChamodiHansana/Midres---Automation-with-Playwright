...
exports.SpecSheetPage = class SpecSheetPage {
    ...
    async navigateToSpecSheetPage() {
        await this.page.getByRole('link', { name: 'Spec Sheets' }).click();
    }

    async navigateToBrandFolderSpecSheets() {
    ...
    async createSpecSheetsFolder() {
        ...
        await this.page.getByRole('textbox', { name: 'Name' }).fill('SpecSheetTestAutomation');
        await this.page.getByTestId('create-btn').click();
        await this.page.getByText('Spec sheet folder Created').click();
    }


    async searchCreatedFilterSpecSheets() {
        await this.page.getByRole('searchbox', { name: 'Search' }).type('SpecSheetTestAutomation');
        await this.page.getByTestId('search-btn').click();
        await this.page.getByLabel('SpecSheetTestAutomation', { exact: true }).click();
        await this.page.waitForTimeout(2000);
    }


    async uploadFilesSpecSheets() {
    ...
    async addToFavoritesSpecSheets() {
        //await this.page.waitForTimeout(2000);
        await this.page.getByRole('cell').nth(4).click();
    ...
    async navigateBackSpecSheets() {
        await this.page.getByRole('link', { name: 'LaCornue' }).click();
    }

    async renameFoldersSpecSheets() {
